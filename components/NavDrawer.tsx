...
const sections: Section[] = [
  {
    ...
    items: [
      ...
      { label: 'Slots', href: '#slots', icon: IconSlots },
      { label: 'Table Games', href: '#table', icon: IconTable },
      { label: 'Video Poker', href: '#poker', icon: IconPoker },
      { label: 'Jackpots', href: '#jackpots', icon: IconJackpot },
      { label: 'Progressive', href: '#progressive', icon: IconProg },
      { label: 'Tournaments', href: '#tournaments', icon: IconTournaments },
    ],
  },
  {
    title: 'Account',
    items: [
      { label: 'Promotions', href: '#promotions', icon: IconPromo },
      { label: 'Rewards', href: '#rewards', icon: IconRewards },
      { label: 'VIP Lounge', href: '#vip', icon: IconVIP },
      { label: 'Banking', href: '#banking', icon: IconBank },
