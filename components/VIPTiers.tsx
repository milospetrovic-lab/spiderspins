  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="tier-reveal mt-10 text-center">
          <a
            href="/menagerie"
            className="hover-target inline-flex items-center gap-2 px-7 py-3 border border-web-light/60 text-silk-dim hover:text-silk uppercase tracking-[0.18em] text-xs font-display font-medium transition-colors"
          >
